...
function MdbPopoverComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
...
function MdbPopoverComponent_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
...
function MdbPopoverComponent_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementStart(0, "div", 2);
    ɵɵtext(1);
    ɵɵelementEnd();
...
var MdbPopoverComponent = class _MdbPopoverComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    decls: 4,
    vars: 5,
    consts: [[1, "popover"], [1, "popover-header"], [1, "popover-body"], [3, "ngTemplateOutlet", "ngTemplateOutletContext"]],
    template: function MdbPopoverComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵconditionalCreate(1, MdbPopoverComponent_Conditional_1_Template, 2, 1, "h3", 1);
        ɵɵconditionalCreate(2, MdbPopoverComponent_Conditional_2_Template, 2, 2, "div", 2);
        ɵɵconditionalCreate(3, MdbPopoverComponent_Conditional_3_Template, 2, 1, "div", 2);
        ɵɵelementEnd();
      }
      if (rf & 2) {
        ...
        ɵɵadvance();
        ɵɵconditional(ctx.isContentTemplate ? 2 : -1);
        ɵɵadvance();
        ɵɵconditional(!ctx.isContentTemplate ? 3 : -1);
      }
    },

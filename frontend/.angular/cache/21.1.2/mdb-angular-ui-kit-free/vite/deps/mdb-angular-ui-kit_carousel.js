...
var _c0 = ["*"];
function MdbCarouselComponent_Conditional_1_For_2_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "button", 6);
    ɵɵlistener("click", function MdbCarouselComponent_Conditional_1_For_2_Template_button_click_0_listener() {
      const ɵ$index_6_r2 = ɵɵrestoreView(_r1).$index;
      const ctx_r2 = ɵɵnextContext(2);
      return ɵɵresetView(ctx_r2.to(ɵ$index_6_r2));
    });
    ɵɵelementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = ɵɵnextContext(2);
    ɵɵclassProp("active", ɵ$index_6_r2 === ctx_r2.activeSlide);
    ɵɵattribute("aria-current", ɵ$index_6_r2 === ctx_r2.activeSlide);
  }
}
function MdbCarouselComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementStart(0, "div", 1);
    ɵɵrepeaterCreate(1, MdbCarouselComponent_Conditional_1_For_2_Template, 1, 3, "button", 5, ɵɵrepeaterTrackByIdentity);
    ɵɵelementEnd();
  }
  if (rf & 2) {
...
function MdbCarouselComponent_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "button", 7);
    ɵɵlistener("click", function MdbCarouselComponent_Conditional_4_Template_button_click_0_listener() {
      ɵɵrestoreView(_r4);
      const ctx_r2 = ɵɵnextContext();
...
function MdbCarouselComponent_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "button", 10);
    ɵɵlistener("click", function MdbCarouselComponent_Conditional_5_Template_button_click_0_listener() {
      ɵɵrestoreView(_r5);
      const ctx_r2 = ɵɵnextContext();
...
var MdbCarouselComponent = class _MdbCarouselComponent {
  ...
  display = true;
  _isBrowser;
  constructor(_elementRef, _cdRef, platformId) {
    this._elementRef = _elementRef;
    this._cdRef = _cdRef;
  ...
  static ɵfac = function MdbCarouselComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _MdbCarouselComponent)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(PLATFORM_ID));
  };
  static ɵcmp = ɵɵdefineComponent({
    ...
    decls: 6,
    vars: 7,
    consts: [[1, "carousel", "slide"], [1, "carousel-indicators"], [1, "carousel-inner"], ["type", "button", 1, "carousel-control-prev"], ["type", "button", 1, "carousel-control-next"], ["type", "button", 3, "active"], ["type", "button", 3, "click"], ["type", "button", 1, "carousel-control-prev", 3, "click"], ["aria-hidden", "true", 1, "carousel-control-prev-icon"], [1, "visually-hidden"], ["type", "button", 1, "carousel-control-next", 3, "click"], ["aria-hidden", "true", 1, "carousel-control-next-icon"]],
    template: function MdbCarouselComponent_Template(rf, ctx) {
      if (rf & 1) {
        ɵɵprojectionDef();
        ɵɵelementStart(0, "div", 0);
        ɵɵconditionalCreate(1, MdbCarouselComponent_Conditional_1_Template, 3, 0, "div", 1);
        ɵɵelementStart(2, "div", 2);
        ɵɵprojection(3);
        ɵɵelementEnd();
        ɵɵconditionalCreate(4, MdbCarouselComponent_Conditional_4_Template, 4, 0, "button", 3);
        ɵɵconditionalCreate(5, MdbCarouselComponent_Conditional_5_Template, 4, 0, "button", 4);
        ɵɵelementEnd();
      }
      if (rf & 2) {
        ɵɵclassProp("carousel-fade", ctx.animation === "fade")("carousel-dark", ctx.dark);
        ɵɵadvance();
        ɵɵconditional(ctx.indicators ? 1 : -1);
        ɵɵadvance(3);
        ɵɵconditional(ctx.controls ? 4 : -1);
        ɵɵadvance();
        ɵɵconditional(ctx.controls ? 5 : -1);
      }
    },
    encapsulation: 2,
    changeDetection: 0

import "./chunk-O5GNI3SY.js";
import {
  Overlay,
  OverlayConfig,
  OverlayModule,
  OverlayPositionBuilder
} from "./chunk-TBHGSGM3.js";
import {
  ComponentPortal
...
function MdbTooltipComponent_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "div", 0);
    ɵɵlistener("@fade.done", function MdbTooltipComponent_Conditional_0_Template_div_animation_fade_done_0_listener($event) {
      ɵɵrestoreView(_r1);
...
function MdbTooltipComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "div", 1);
    ɵɵlistener("@fade.done", function MdbTooltipComponent_Conditional_1_Template_div_animation_fade_done_0_listener($event) {
      ɵɵrestoreView(_r3);
      const ctx_r1 = ɵɵnextContext();
      return ɵɵresetView(ctx_r1.onAnimationEnd($event));
    });
...
var MdbTooltipComponent = class _MdbTooltipComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    decls: 2,
    vars: 2,
    consts: [[1, "tooltip-inner", 3, "innerHTML"], [1, "tooltip-inner"]],
    template: function MdbTooltipComponent_Template(rf, ctx) {
      if (rf & 1) {
        ɵɵconditionalCreate(0, MdbTooltipComponent_Conditional_0_Template, 1, 3, "div", 0);
        ɵɵconditionalCreate(1, MdbTooltipComponent_Conditional_1_Template, 2, 3, "div", 1);
      }
      if (rf & 2) {
        ɵɵconditional(ctx.html ? 0 : -1);
        ɵɵadvance();
        ɵɵconditional(!ctx.html ? 1 : -1);
      }
    },
    encapsulation: 2,
    data: {

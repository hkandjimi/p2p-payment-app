...
import {
  DomSanitizer
} from "./chunk-NGG6RJGB.js";
import "./chunk-PTW3ZZRO.js";
import "./chunk-FGZDQ7EU.js";
import {
  coerceElement,
  coerceNumberProperty
} from "./chunk-NQ4HA5NT.js";
import {
  CommonModule,
  NgClass
...
var MdbModalContainerComponent = class _MdbModalContainerComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    viewQuery: function MdbModalContainerComponent_Query(rf, ctx) {
      if (rf & 1) {
        ɵɵviewQuery(CdkPortalOutlet, 7)(_c0, 7)(_c1, 7);
      }
      if (rf & 2) {
        let _t;
    ...
    hostBindings: function MdbModalContainerComponent_HostBindings(rf, ctx) {
      if (rf & 1) {
        ɵɵlistener("resize", function MdbModalContainerComponent_resize_HostBindingHandler() {
...
var MdbModalService = class _MdbModalService {
  ...
  _overlay;
  _injector;
  constructor(_document, _overlay, _injector) {
    this._document = _document;
  ...
  static ɵfac = function MdbModalService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _MdbModalService)(ɵɵinject(DOCUMENT), ɵɵinject(Overlay), ɵɵinject(Injector));
  };
  static ɵprov = ɵɵdefineInjectable({

...
function MdbAccordionItemComponent_Conditional_3_ng_template_0_Template(rf, ctx) {
}
function MdbAccordionItemComponent_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, MdbAccordionItemComponent_Conditional_3_ng_template_0_Template, 0, 0, "ng-template", 2);
  }
  if (rf & 2) {
...
function MdbAccordionItemComponent_Conditional_6_ng_template_0_Template(rf, ctx) {
}
function MdbAccordionItemComponent_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵtemplate(0, MdbAccordionItemComponent_Conditional_6_ng_template_0_Template, 0, 0, "ng-template", 2);
  }
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext();
...
var MdbAccordionItemComponent = class _MdbAccordionItemComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    contentQueries: function MdbAccordionItemComponent_ContentQueries(rf, ctx, dirIndex) {
      if (rf & 1) {
        ɵɵcontentQuery(dirIndex, MDB_ACCORDION_ITEM_HEADER, 7, TemplateRef)(dirIndex, MDB_ACCORDION_ITEM_BODY, 7, TemplateRef);
      }
      if (rf & 2) {
        let _t;
    ...
    decls: 7,
    vars: 11,
    consts: [[1, "accordion-header", 3, "id"], ["type", "button", 1, "accordion-button", 3, "click"], [3, "ngTemplateOutlet"], ["mdbCollapse", "", 3, "collapseShow", "collapseHide", "collapseShown", "collapseHidden"], [1, "accordion-body"]],
    template: function MdbAccordionItemComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵtext(2);
        ɵɵconditionalCreate(3, MdbAccordionItemComponent_Conditional_3_Template, 1, 1, null, 2);
        ɵɵelementEnd()();
        ...
        ɵɵconditionalCreate(6, MdbAccordionItemComponent_Conditional_6_Template, 1, 1, null, 2);
        ɵɵelementEnd()();
      }
      if (rf & 2) {
        ...
        ɵɵadvance();
        ɵɵconditional(ctx._headerTemplate ? 3 : -1);
        ɵɵadvance();
        ɵɵattribute("id", ctx.id)("aria-labelledby", ctx._headerId);
        ɵɵadvance(2);
        ɵɵconditional(ctx._bodyTemplate ? 6 : -1);
      }
    },
    dependencies: [NgTemplateOutlet, MdbCollapseDirective],
    encapsulation: 2,
    changeDetection: 0
  });
};

...
import { DOCUMENT, HostListener, HostBinding, ViewChild, Inject, ChangeDetectionStrategy, Component, TemplateRef, Injector, Injectable, NgModule } from '@angular/core';
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "21.1.2", ngImport: i0, type: MdbModalService, decorators: [{
            type: Injectable
                    ...
                    type: Inject,
                    args: [DOCUMENT]
                }] }, { type: i1$1.Overlay }, { type: i0.Injector }] });

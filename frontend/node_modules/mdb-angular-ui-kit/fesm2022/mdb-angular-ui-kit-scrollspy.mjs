...
import { DOCUMENT, HostListener, HostBinding, Input, Inject, Directive, Injectable, EventEmitter, PLATFORM_ID, Output, ContentChildren, Component, NgModule } from '@angular/core';

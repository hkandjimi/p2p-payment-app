...
import { HostBinding, Input, Component, EventEmitter, PLATFORM_ID, HostListener, Output, ContentChildren, Inject, ChangeDetectionStrategy, NgModule } from '@angular/core';
